...
enum ThorimSpells
{
	...
	SPELL_CHAIN_LIGHTNING_10				= 64390,
	SPELL_CHAIN_LIGHTNING_25				= 62131,
...
// SIF
#define SPELL_BLIZZARD				RAID_MODE(SPELL_BLIZZARD_10, SPELL_BLIZZARD_25)
#define SPELL_FROSTBOLT				RAID_MODE(SPELL_FROSTBOLT_10, SPELL_FROSTBOLT_25)
#define SPELL_FROSTBOLT_VALLEY		RAID_MODE(SPELL_FROSTBOLT_VALLEY_10, SPELL_FROSTBOLT_VALLEY_25)
